...
def upgrade() -> None:
    ...
    op.create_unique_constraint('uq_tool_version', 'tool_versions', ['tool_id', 'version'])
    ...
    op.create_index(op.f('ix_resource_limits_resource_type'), 'resource_limits', ['resource_type'], unique=False)
    op.create_index(op.f('ix_resource_limits_user_id'), 'resource_limits', ['user_id'], unique=False)
    op.create_unique_constraint('uq_user_resource_limit', 'resource_limits', ['user_id', 'resource_type'])
    
    # Add developer_id column to tools table
    op.add_column('tools', sa.Column('developer_id', sa.String(length=36), nullable=True))
    op.create_foreign_key(None, 'tools', 'developers', ['developer_id'], ['id'])
    op.create_index(op.f('ix_tools_developer_id'), 'tools', ['developer_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_resource_limits_resource_type'), table_name='resource_limits')
