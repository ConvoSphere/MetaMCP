...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_execution_history_status'), 'execution_history', ['status'], unique=False)
    op.create_index(op.f('ix_execution_history_tool_id'), 'execution_history', ['tool_id'], unique=False)
    ...
    op.create_index(op.f('ix_search_history_status'), 'search_history', ['status'], unique=False)
    ...
    op.create_index(op.f('ix_vector_embeddings_tool_id'), 'vector_embeddings', ['tool_id'], unique=False)
