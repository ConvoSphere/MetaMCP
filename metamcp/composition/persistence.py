...
from metamcp.composition.models import WorkflowDefinition, WorkflowExecution, WorkflowStep
...
class WorkflowPersistence:
    ...
    async def _create_tables(self) -> None:
        ...
        try:
            ...
            raise WorkflowPersistenceError(f"Failed to initialize persistence layer: {e}")
    ...
    async def save_workflow(self, workflow: WorkflowDefinition) -> None:
        ...
        try:
            workflow_data = {
                ...
                "definition": json.dumps(workflow.dict()),
            ...
            if existing:
                ...
                """, 
                    ...
                    workflow.version, workflow_data["definition"], workflow_data["updated_at"]
                )
                ...
                """,
                    workflow.id, workflow.name, workflow.description,
                    workflow.version, workflow_data["definition"],
                    datetime.utcnow(), workflow_data["updated_at"]
                )
    ...
    async def save_execution(self, execution: WorkflowExecution) -> None:
        ...
        try:
            execution_data = {
                ...
                "error_data": json.dumps(execution.error_data) if execution.error_data else None,
            ...
            if existing:
                ...
                await self.db.execute("""
                    ...
                    WHERE id = $1
                """,
                    execution.id, execution_data["status"], execution_data["output_data"],
                    execution_data["error_data"], execution_data["execution_time"],
                ...
                """,
                    execution.id, execution.workflow_id, execution_data["status"],
                    execution_data["input_data"], execution_data["output_data"],
                    execution_data["error_data"], execution_data["execution_time"],
    ...
    async def load_execution(self, execution_id: str) -> Optional[Dict[str, Any]]:
...
_persistence_manager: Optional[WorkflowPersistence] = None
