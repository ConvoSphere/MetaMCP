...
from ..exceptions import ToolNotFoundError, ToolExecutionError, ToolRegistrationError
...
class ToolRegistry:
    ...
    async def _generate_tool_embedding(self, tool_data: Dict[str, Any]) -> List[float]:
        ...
        try:
            ...
            return [0.0] * 8  # Default embedding
    ...
    async def search_tools(
        ...
        try:
            ...
            if self.llm_service:
                ...
                query_embedding = [float(b) / 255.0 for b in hash_obj.digest()[:8]]
