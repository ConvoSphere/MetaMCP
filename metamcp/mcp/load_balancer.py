...
class LoadBalancer:
    ...
    async def _least_response_time_select(self, servers: List[ServerConfig]) -> ServerConfig:
    ...
    async def _ip_hash_select(self, servers: List[ServerConfig], client_id: str) -> ServerConfig:
    ...
    async def _consistent_hash_select(self, servers: List[ServerConfig], client_id: str) -> ServerConfig:
...
class LoadBalancedMCPClient:
    ...
    async def _send_request_to_server(self, connection: Any, request: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _update_server_stats(self, server_id: str, success: bool) -> None:
        ...
        await self.load_balancer.update_server_connection_count(server_id, connection_count)
