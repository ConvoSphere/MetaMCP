...
def cache_result(
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def sync_wrapper(*args, **kwargs):
            ...
            logger.warning(f"Sync function {func.__name__} cannot be cached with async decorator")
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            if pattern:
                ...
                logger.debug(f"Invalidated {cleared} cache entries with pattern: {pattern}")
            elif key_generator:
        ...
        def sync_wrapper(*args, **kwargs):
            ...
            logger.warning(f"Sync function {func.__name__} cache invalidation not supported")
            return result
    ...
    def decorator(method: Callable) -> Callable:
        ...
        async def async_wrapper(self, *args, **kwargs):
            ...
            if include_self:
                ...
                cache_key = _generate_cache_key(method, (self_key,) + args, kwargs, key_prefix)
            else:
        ...
        def sync_wrapper(self, *args, **kwargs):
            ...
            logger.warning(f"Sync method {method.__name__} cannot be cached with async decorator")
