...
class TestToolRegistrySecurity:
    ...
    def test_register_tool_creation(self, tool_registry_security):
        ...
        success = tool_registry_security.register_tool_creation("non_existent", "tool_456")
        assert success is False
    ...
    def test_list_developers(self, tool_registry_security):
        ...
        dev1_id = tool_registry_security.register_developer("dev1", "dev1@test.com", "Org1")
        dev2_id = tool_registry_security.register_developer("dev2", "dev2@test.com", "Org2")
