...
class TestAPIVersion:
    ...
    def test_version_is_deprecated(self):
        ...
        # Not deprecated
        version = APIVersion(
            version="v1", status=VersionStatus.ACTIVE, release_date=datetime.utcnow()
        )
...
class TestAPIVersionManager:
    ...
    def test_register_version(self, manager):
        ...
        version = APIVersion(
            version="v3", status=VersionStatus.ACTIVE, release_date=datetime.utcnow()
        )
    ...
    def test_get_latest_version(self, manager):
        ...
        v2 = APIVersion(
            version="v2", status=VersionStatus.ACTIVE, release_date=datetime.utcnow()
        )
    ...
    def test_get_active_versions(self, manager):
        ...
        v3 = APIVersion(
            version="v3", status=VersionStatus.SUNSET, release_date=datetime.utcnow()
        )
...
class TestVersionMiddleware:
    ...
    async def test_version_detection(self):
        ...
        with patch(
            "metamcp.api.versioning.get_api_version_manager"
        ) as mock_get_manager:
            manager = Mock()
